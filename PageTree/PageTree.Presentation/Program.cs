...
using PageTree.Presentation.Services;
using PageTree.Presentation;
...
builder.Services.AddScoped(sp => sp.GetRequiredService<IHttpClientFactory>().CreateClient("PageTree.Api"));
